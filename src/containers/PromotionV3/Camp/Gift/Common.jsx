...
const formKeys1 = ['giftID', 'giftTotalCount', 'effectType', 'countType', 'giftEffectTimeHours', 'giftValidUntilDayCount'];
const formKeys2 = ['giftID', 'giftTotalCount', 'effectType', 'rangeDate'];
const formItems = {
    giftID: {
        type: 'custom',
        label: '礼品名称',
