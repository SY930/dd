...
import lotteryBg from './assets/lotteryBg.png';
        ...
        return (
            <div className={style.previewArea}>
                ...
                <div style={{ background: bgColor, paddingTop: 80 }} className={style.scrollArea}>
                    ...
                    <img style={{ width: '90%', margin: '0 5%', position: 'relative', zIndex: 10, height: 293 }} src={lotteryBgImg || lotteryBg} alt="" />
                    <img style={{ width: '75%', margin: '0 5%', position: 'absolute', zIndex: 21, top: 106, left: 20, }} src={lottery} alt="" />
                    {/* 大按钮 */}
                    {/* <div
    ...
    renderSettingPanel() {
        ...
        return (
            <div style={{ paddingTop: 35 }}>
                ...
                <div className={style.sectionWrapper}>
                    <div style={{ top: 30 }} className={style.label}>转盘背景</div>
                    <div style={{ width: 350 }} className={style.uploaderWrapper}>
                        <DecorationUploader
                            limit={0}
                            value={lotteryBgImg}
                            onChange={value => onChange({ key: ['lotteryBgImg'], value })}
                        />
                        <div className={style.uploaderTip}>
                            <p>* {SALE_LABEL.k6346css}696x798</p>
                            <p>* {SALE_LABEL.k6346ckg}1000KB</p>
                            <p>* {SALE_LABEL.k6346d14}</p>
                        </div>
                    </div>
