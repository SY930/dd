/*
 * @Author: dangxiaorun
 * @Date: 2022-04-29 15:01:33
 * @LastEditors: dangxiaorun
 * @LastEditTime: 2022-04-29 17:32:55
...
@injectIntl
export default class SpecialPromotionDetailExportModal extends Component {
    constructor(props) {
        super(props);
        this.data = {};
        this.state = {
    ...
    componentDidMount() {
        ...
        if(!sameItemID){
            axiosData(
                ...
                { eventID, eventName, keyword, exportType: 19 },
                null,
                { path: 'data' },
            ).then(_records => {
                setTimeout(() => {
    ...
    getExportRecords = (key) => {
        ...
        axiosData('/crm/quotaCardExport/getRecords.ajax', { exportQuotaType: '19' }, null, { path: 'data' })
            .then(data => {
    ...
    handleClearAll = () => {
        axiosData('/crm/quotaCardExport/delete.ajax', { exportQuotaType: '19' }, null, { path: 'data' })
            .then(() => {
                message.success(COMMON_GIFT.doj9y10hl476);
                this.getExportRecords();
            });
