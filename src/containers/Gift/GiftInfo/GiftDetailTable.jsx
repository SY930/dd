        ...
        if(null!==parentDoms){                                                  //如果父级节点不是空将执行下列代码
            ...
            if(undefined !== contentrDoms && contentrDoms.length > 0) {         //如果 contentrDoms 节点存在 并且length>0 时执行下列代码
                ...
                this.setState({
                    ...
                    tableHeight:layoutsContent.getBoundingClientRect().height - 120
                })
            }
        }
    }
...
function mapStateToProps(state) {
    return {
        ...
        dataSource: state.sale_old_giftInfo.get('dataSource'),
        loading: state.sale_old_giftInfo.get('loading'),
    }
}
