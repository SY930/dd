...
class VoucherDetailInfo extends React.Component{
    ...
    renderVoucher(){
        ...
        return (
            <div>
                <FormItem label="减免金额" className={[styles.FormItemStyle,styles.priceInputSingle].join(' ')} labelCol={{span:4}}
                          wrapperCol={{span:17}} required={true} validateStatus={this.state.giftValueFlag?'success':'error'}
                ...
                <FormItem label="代金券" className={[styles.FormItemStyle,styles.foodCount].join(' ')} labelCol={{span:4}}
                          wrapperCol={{span:17}}>
                    {getFieldDecorator('giftName', {
                        ...
                        <TreeSelect className={styles.selectIn}
