    ...
    renderRulesComponent() {
        return (this.state.ruleInfo.map((ruleInfo, index) => {
            ...
            return (
                <Row key={`${index}`}>
                    <Col>
                        <FormItem label=" " className={styles.FormItemStyle} labelCol={{
                        span: 4
                    }} wrapperCol={{
                        span: 17
                    }} validateStatus={ruleInfo.validationStatus} help={ruleInfo.helpMsg}>
                            <CustomRangeInput
                                relation = {'返积分比例'}
