...
import {fetchRoleListInfoAC, saleCenterSetPromotionDetailAC} from '../../../redux/actions/saleCenter/promotionDetailInfo.action';
...
class EditBoxForSubject extends React.Component {
    ...
    initialState(roleList, roleCollection){
        ...
        let _roleSelections = this.state.roleSelections;
    ...
    componentDidMount(){
        ...
        let _roles = this.props.promotionDetailInfo.getIn(["$roleInfo", "data", "roleTree"]).toJS();
        let _role = this.props.promotionDetailInfo.getIn(["$promotionDetail", "role"]).toJS();
    ...
    componentWillReceiveProps(nextProps){
        ...
        if (this.props.promotionDetailInfo.getIn(["$roleInfo", "data", "roleTree"]) !=
            ...
            let _roles = nextProps.promotionDetailInfo.getIn(["$roleInfo", "data", "roleTree"]).toJS();
        ...
        if (this.props.promotionDetailInfo.getIn(["$promotionDetail", "role"]) !=
            ...
            let _role = nextProps.promotionDetailInfo.getIn(["$promotionDetail", "role"]).toJS();
            this.setState({
                role: _role
            }, ()=>{
                this.initialState(this.state.role, this.state.roleCollection);
    ...
    render(){
        let _roleCollection = this.state.roleCollection;
        const loop = (data) => {
            if (undefined === data) {
                return null
            }
    ...
    handleSearchInputChange(value){
        ...
        let roleList = this.state.roleCollection;
        ...
        this.setState({
            ...
            roleCurrentSelections: roleCurrentSelections
        });
    }
    ...
    handleSelectedChange(value){
        let roleSelections = this.state.roleSelections;
    ...
    handleGroupSelect(value){
        if (value instanceof Array) {
            // get the selections
            let selectionsSet = this.state.roleSelections;
    ...
    handleTreeNodeChange(value) {
        ...
        this.setState({roleOptions: storeOptions, roleCurrentSelections: roleCurrentSelections});
