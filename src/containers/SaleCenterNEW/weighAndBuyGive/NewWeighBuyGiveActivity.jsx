...
* @Filename: NewWeighBuyGiveActivity.jsx
* @Last modified by:   xf
...
class NewWeighBuyGiveActivity extends NewPromotion {
    constructor(props) {
        super(props);
    }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(NewWeighBuyGiveActivity);
