...
class MyActivities extends React.Component {
    ...
    goSearch = ({ key }) => {
        ...
        const { isActive } = itm
        console.log("🚀 ~ file: MyActivities.jsx ~ line 318 ~ MyActivities ~ isActive", isActive)
    ...
    getSearchListContent = () => {
        axiosData(
            ...
            if (res.code === '000') {
                ...
                console.log("🚀 ~ file: MyActivities.jsx ~ line 368 ~ MyActivities ~ ).then ~ filterSchemeList", filterSchemeList)
                this.setState({
                    filterSchemeList
                })
            }
