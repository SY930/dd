                        ...
                        <div style={{width:'350px',float:'left',marginLeft:'10px'}}>
                            ...
                            <Tooltip title={
                                <p style={{fontSize:'12px'}}>
                                    <b>配置为次日可用时段的定义：</b><br/>
                                    &nbsp;&nbsp;配置适用时段，起止时间跨00:00时，如果勾选【配置为次日使用】时段，则00:00至截止时间的时端，计算为次日可用时段。<br/>
                                    &nbsp;&nbsp;配置适用时段，起止时间跨00:00时，如果勾选【配置为次日使用】时段，则00:00至截止时间的时端，计算为当日可用时段。<br/>
                                    <b>举例说明：</b><br/>
                                    &nbsp;&nbsp;勾选【配置为次日可用】：需要券可核销时间为当日的22:00开始至次日的05:00之间，可配置【使用时段】为22:00-05:00，<br/>&nbsp;&nbsp;勾选【配置为次日可用】后，保存成功，则券的可核销时间为当日的22:00开始至次日的05:00之间。<br/>
                                    &nbsp;&nbsp;未勾选【配置为次日可用】：需要券可核销时间为当日的00:00-05:00和当日22:00-23:59:59之间，可配置【使用时段】为22:00-05:00，<br/>&nbsp;&nbsp;不勾选【配置为次日可用】后，保存成功，则券的可核销时间为当日的00:00-05:00和当日22:00-23:59:59之间。<br/>
                                </p>
                            }>
