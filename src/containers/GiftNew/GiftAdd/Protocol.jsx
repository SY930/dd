		...
		return (
			...
			>
				<div>
					<p>一、声明与授权</p>
					<p>
						1.您承诺，储值业务、优惠券以及优惠活动等信息均由您发布，基于发布的信息您提供的商品/服务均由您独立运营并承担全部责任；北京多来点信息技术有限公司及关联公司（以下简称“哗啦啦系统”或“我们”）仅受您委托为您提供信息发布相关的技术支持服务，我们并不对您发布的信息和提供的服务负责。
					</p>
					<p>二、责任限制和免责</p>
					<p>
						1.您提供产品或服务前，应具备法律法规规定的与为您提供服务相适应的权利及资格亦或经过权利人的合法授权或经过政府主管部门的审批或已经向政府主管部门作备案，获得相关部门的明确批准或认可，如您不具备上述主体资格的，请勿同意本声明。
					</p>
					<p>
					...
					<p>4.对下列情形，我们不承担任何责任：</p>
					<p>4.1由于您的故意或过失导致您及/或任何第三方遭受损失的。</p>
					<p>4.2在您和第三方发生的任何争议，或双方就该争议无法达成一致时，我们单方中止和（或）终止提供信息发布服务。</p>
					<p>4.3因不可抗力导致我们不能履行其义务的。</p>
					<p>三、根据《单用途商业预付卡管理办法（试行）》及其他相关规定，如您设置储值预付卡业务的，建议您：</p>
					<p>1.发卡企业应在开展单用途卡业务之日起30日内按照下列规定办理备案:</p>
					<p>1.1集团发卡企业和品牌发卡企业向其工商登记注册地省、自治区、直辖市人民政府商务主管部门备案;</p>
					<p>1.2规模发卡企业向其工商登记注册地设区的市人民政府商务主管部门备案;</p>
					<p>1.3其他发卡企业向其工商登记注册地县(市、区)人民政府商务主管部门备案。</p>
					<p>2.储值卡储值金额限制：</p>
					<p>
					...
					<p>2.3 单张记名卡限额不得超过5000元，单张不记名卡限额不得超过1000元。</p>
				</div>
			</Modal>
		);
	}
