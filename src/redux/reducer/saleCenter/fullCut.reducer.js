...
} from '../../actions/saleCenter/fullCutActivity.action.js';
...
export function fullCut($$state = $initialState, action) {
    switch (action.type) {
        ...
        case DEL_EXCLUDED_DATE_OF_FULLCUT_ACTIVITY:
            ...
            let tempExcludedDate = $$state.get("excludedDate").splice(index, 1);
