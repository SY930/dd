...
} from '../../actions/saleCenter/promotionBasicInfo.action.js';
...
export const promotionBasicInfo = ($$state = $initialState, action) => {
    switch (action.type) {
        ...
        case SALE_CENTER_SET_ACTIVITY_BASIC_INFO:
            let _$$state = $$state.mergeIn(["$basicInfo"], Immutable.fromJS(action.payload));
            return _$$state;
