...
export const saleCenterSaveCreateMemberGroupParams = (opts) => {
    return {
        type: SALE_CENTER_QUERY_GROUP_CRM_RFM,
        payload: opts,
    };
};
    ...
    return (dispatch) => {
        axiosData(
            ...
            dispatch({
                ...
                payload: {
                    excludeCardTypeIDs: Array.isArray(excludeCardTypeIDs)
                        ? excludeCardTypeIDs
                        : [],
...
export const addSpecialPromotionCancel = () => ({
    type: SALE_CENTER_ADD_SPECIAL_PROMOTION_CANCEL,
});
export const addSpecialPromotionTimeout = () => ({
    type: SALE_CENTER_ADD_SPECIAL_PROMOTION_TIMEOUT,
});
...
export const addSpecialPromotion = (opts) => {
    return (dispatch) => {
        ...
        fetch('/api/specialPromotion/addEvent_NEW', {
            ...
            .catch((error) => {
                throw new Error(
                    `fetchSpecialPromotionDetailAC cause problem with msg ${error}`
                );
            })
            .then(
                (response) => {
...
export const updateSpecialPromotionTimeout = () => ({
    type: SALE_CENTER_UPDATE_SPECIAL_PROMOTION_TIMEOUT,
});
...
export const fetchSpecialGroupMemberCancel = () => ({
    type: SALE_CENTER_FETCH_GROUP_MEMBER_CANCEL,
});
export const fetchSpecialGroupMemberTimeout = () => ({
    type: SALE_CENTER_FETCH_GROUP_MEMBER_TIMEOUT,
});
...
export const fetchSpecialGroupMember = (opts) => {
    return (dispatch) => {
        ...
        fetch('/crm/getGroupCardTypeLevels.ajax', {
            ...
            .catch((error) => {
                throw new Error(
                    `fetchPromotionDetailAC cause problem with msg ${error}`
                );
            })
            .then(
                (response) => {
