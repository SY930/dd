...
export const fetchPromotionListAC = (opts) => {
    return (dispatch) => {
        ...
        const config = getSpecifiedUrlConfig('getPromotionList', opts);
...
export const fetchRoleListInfoAC = (opts) => {
    return (dispatch) => {
        ...
        const config = getSpecifiedUrlConfig('getRole', opts);
...
export const fetchGiftListInfoAC = (opts) => {
    return (dispatch) => {
        ...
        const config = getSpecifiedUrlConfig('getGift', opts);
...
export const fetchSubjectListInfoAC = (opts) => {
    return (dispatch) => {
        ...
        const config = getSpecifiedUrlConfig('getSubject', opts);
