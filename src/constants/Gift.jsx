...
const GiftCfg = {
    giftType: [
        ...
        { name: '菜品兑换券', describe: '用户支付一定的金额可以兑换到相同的菜品', value: '999', color: '#c49b79', tags: ['SaaS2.0'] },
        ...
        { name: '线上礼品卡', describe: '用于线上渠道投放的定额礼品卡，支持多平台购买转赠、消费', value: '91', color: '#84aac6', tags: ['微信小程序'] },
