const CrmOperationCfg = {
  ...
  operationTypeKeys: [
    ...
    {type: 'recharge', keys: ['shopID','transWay','transAmount','transReturnMoneyAmount','transReturnPointAmount','subjectName','transRemark']},
    {type: 'recede', keys: ['shopID','refundMoneyAmount','refundGiveAmount','refundPointAmount','transRemark']},
    ...
    {type: 'change', keys: ['shopID','newCardNO','cardFee']},
    ...
    {type: 'adjustment', keys: ['transType','adjustMoneyBalance','adjustGiveBalance','adjustPointBalance','shopID','transRemark','visiable','smsContent']},
    ...
    {type: 'invoice', keys: ['shopID','invoiceNum', 'invoiceTitle', 'taxNum', 'invoiceValue', 'remark']},
  ]
}
